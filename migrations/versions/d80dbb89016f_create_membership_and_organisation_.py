...
Revision ID: d80dbb89016f
Revises: 41efd0e44e75
Create Date: 2019-09-18 15:20:22.327145
...
def upgrade():
    ...
    op.create_table(
        'Membership', sa.Column('id', sa.String(length=21), nullable=False),
    ...
    op.add_column(
        'User', sa.Column('first_name', sa.String(length=20), nullable=False))
    op.add_column('User',
    ...
    op.create_unique_constraint('user_email_unique_constraint', 'User',
                                ['email'])
